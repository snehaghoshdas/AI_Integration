...
import static com.aiSolution.hack.ide.toolwindow.ToolWindowUtil.createIconLabel;
import static com.aiSolution.hack.ide.toolwindow.ToolWindowUtil.createTextArea;
import static com.aiSolution.hack.ide.toolwindow.ToolWindowUtil.justifyLeft;
import static java.lang.String.format;

import com.aiSolution.hack.ide.settings.SettingsConfigurable;
...
import com.aiSolution.hack.ide.toolwindow.components.SyntaxTextArea;
import icons.Icons;
...
public class ToolWindowService implements LafManagerListener {
  ...
  public ToolWindow getToolWindow(@NotNull Project project) {
    return ToolWindowManager.getInstance(project).getToolWindow("AI Asisstant");
  }
  ...
  public void sendMessage(String prompt, Project project, @Nullable Runnable scrollToBottom) {
    addSpacing(16);
    addIconLabel(Icons.DefaultImageIcon, "AI Assistant:");
    addSpacing(8);
